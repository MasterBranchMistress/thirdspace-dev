...
export default function TermsPage() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-12 text-white animate-appearance-in">
      <h1 className={title()}>Terms and Conditions</h1>
      <p className="mt-4 text-sm text-white/70">Last updated: August 1, 2025</p>

      <section className="mt-8 space-y-6 text-sm leading-6">
        <p>
          By creating an account or using the ThirdSpace platform, you agree to
        ...
        <p>
          We’re all about respect and connection. No harassment, hate speech, or
          abuse will be tolerated. Violators may be banned without notice.
        </p>
        ...
        <p>
          ...
          <Link href="/privacy" className="text-indigo-800 underline">
            Privacy Policy
          </Link>{" "}
          for details.
        </p>
        ...
        <p>
          You own your content. By posting on ThirdSpace, you grant us a license
          to display and distribute your content within the app for others to
          see and engage with.
        </p>
