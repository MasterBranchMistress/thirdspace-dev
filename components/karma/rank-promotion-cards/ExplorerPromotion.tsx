...
export default function ExplorerPromotion({
  actor,
  target,
  timestamp,
}: PromotionRankProps) {
  ...
  return (
    <div className="relative w-full mt-4 overflow-hidden rounded-none p-[1px] bg-none">
      ...
      >
        <source src="/videos/explorer.mp4" type="video/mp4" />
      </video>
      ...
      <div className="relative rounded-2xl bg-content1 px-6 py-10 flex flex-col items-center justify-center text-center gap-4">
        ...
        />
        <p>
          Curiosity leads the way. <br />
          <br />
          Explorers are venturing deeper into ThirdSpace, discovering events,
          conversations, and communities that spark their interest. With every
          new connection and shared moment, the world of possibilities grows a
          little larger. <br />
          <br />
          Keep exploring! The best discoveries are still ahead.
        </p>
        {/* Timestamp */}
        <Lottie
          animationData={cheer}
