...
export default function NavigatorPromotion({
  actor,
  target,
  timestamp,
}: PromotionRankProps) {
  ...
  return (
    <div className="relative w-full mt-4 overflow-hidden rounded-none p-[1px] bg-none">
      ...
      >
        <source src="/videos/promotion-backdrop.mp4" type="video/mp4" />
      </video>
      ...
      <div className="relative rounded-2xl bg-content1 px-6 py-10 flex flex-col items-center justify-center text-center gap-4">
        ...
        />
        <p>
          Navigators help chart the social map of ThirdSpace. <br />
          <br /> Through events, conversations, and shared interests, they help
          others discover where the community is headed next. A Navigator has
          proven they can move beyond drifting, now they help point the way.{" "}
          <br />
          <br /> See you out there, Navigator!
        </p>
        {/* Timestamp */}
        <Lottie
          animationData={cheer}
