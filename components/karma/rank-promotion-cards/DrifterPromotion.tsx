...
export default function DrifterPromotion({
  actor,
  target,
  timestamp,
}: PromotionRankProps) {
  ...
  return (
    <div className="relative w-full mt-4 overflow-hidden rounded-none p-[1px] bg-none">
      ...
      >
        <source src="/videos/drifter.mp4" type="video/mp4" />
      </video>
      ...
      <div className="relative rounded-2xl bg-content1 px-6 py-10 flex flex-col items-center justify-center text-center gap-4">
        ...
        />
        <p>
          Every journey starts somewhere. <br />
          <br />
          Drifters are just beginning to explore the world of ThirdSpace,
          discovering events, conversations, and new people along the way. It’s
          a time for curiosity, wandering, and finding the communities that feel
          like home. <br />
          <br />
          For now, just drift and see where the current takes you.
        </p>
        {/* Timestamp */}
        <Lottie
          animationData={cheer}
